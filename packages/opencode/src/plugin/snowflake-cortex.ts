...
<html>
  <head><title>Ekode - Snowflake Authorization Successful</title></head>
...
<html>
  <head><title>Ekode - Snowflake Authorization Failed</title></head>
  <body style="font-family: system-ui; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#111; color:#eee;">
      ...
      methods: [
        {
          ...
          async authorize(inputs = {}) {
            ...
            return {
              url,
              instructions:
                "Complete Snowflake sign-in in your browser. Ekode will capture the OAuth callback and store the bearer token automatically.",
