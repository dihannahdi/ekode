...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Ekode from reading sensitive files",
  "Use {highlight}ekode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}ekode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}ekode serve{/highlight} for headless API access to Ekode",
  "Use {highlight}ekode run --attach{/highlight} to connect to a running server",
  "Run {highlight}ekode upgrade{/highlight} to update to the latest version",
  "Run {highlight}ekode auth list{/highlight} to see all configured providers",
  ...
  "Use {highlight}/connect{/highlight} with Eko AI for curated, tested models",
