export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Ekowork",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Ekowork er lastet ned. Vil du installere den og starte på nytt?",
