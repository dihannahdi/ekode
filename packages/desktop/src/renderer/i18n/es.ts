export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Ekowork",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Ekowork. ¿Quieres instalarla y reiniciar?",
