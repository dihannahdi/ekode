export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Ekowork",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Ekowork er blevet downloadet. Vil du installere den og genstarte?",
