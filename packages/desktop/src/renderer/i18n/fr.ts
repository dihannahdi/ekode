export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Ekowork",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Ekowork a été téléchargée. Voulez-vous l'installer et redémarrer ?",
