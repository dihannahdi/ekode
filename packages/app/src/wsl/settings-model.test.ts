...
describe("WSL server settings presentation", () => {
  ...
  test("offers install and update only when Ekowork needs attention", () => {
  ...
  test("probes the selected distro before entering the Ekowork step", async () => {
    const calls: string[] = []
