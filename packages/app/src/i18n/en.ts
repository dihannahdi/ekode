export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Ekowork",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Ekowork.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Eko AI gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Ekowork.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Ekowork.",
  ...
  "dialog.server.description": "Switch which Ekowork server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Ekowork",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Ekowork...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Ekowork in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Ekowork...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Ekowork in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Ekowork in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Ekowork",
  "wsl.onboarding.opencodeReadyIn": "Ekowork is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Ekowork is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Ekowork in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Ekowork",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Ekowork.",
  ...
  "toast.update.description": "A new version of Ekowork ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Ekowork team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Ekowork does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Ekowork includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Ekowork Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Ekowork server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Ekowork",
  ...
  "settings.general.row.appearance.description": "Customise how Ekowork looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Ekowork follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Ekowork is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Ekowork launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Ekowork.",
